...
from streamlined_qsar_app.utils import qsar_api
from streamlined_qsar_app.utils.qsar_api import QSARToolboxAPI, QSARConnectionError, QSARTimeoutError, QSARResponseError, SearchOptions # [cite: 94, 95]
...
def api_client():
    ...
    from streamlined_qsar_app.utils.qsar_api import QSARToolboxAPI, SearchOptions
...
@patch('streamlined_qsar_app.utils.qsar_api.requests.Session.request') # [cite: 95]
def test_search_by_name_success(mock_request, api_client):
    ...
    from streamlined_qsar_app.utils.qsar_api import SearchOptions
...
def test_search_by_smiles_timeout(mock_request, api_client):
    ...
    from streamlined_qsar_app.utils.qsar_api import QSARTimeoutError
...
def test_get_all_chemical_data_error_response(mock_request, api_client):
    ...
    from streamlined_qsar_app.utils.qsar_api import QSARResponseError
    mock_response = MagicMock()
